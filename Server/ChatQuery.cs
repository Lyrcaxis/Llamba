...
public struct ChatQuery {
	...
	/// <summary> How many chat completion choices to generate for each input message. Currently unused. </summary>
	[JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)] public int? n { get; set; }
}